...
from livebot.datatypes import Item, ItemCraft
...
ITEMS: Final = [
    ...
    Item(
        ...
        craft=[
            ItemCraft(name="мука", quantity=3),
            ItemCraft(name="вода", quantity=5),
        ],
        effect=10,
        price=100,
        is_consumable=True,
    ...
    Item(
        ...
        rarity=ItemRarity.RARE,
        is_quest_item=True,
        quest_coin=range(6000, 7500),
        can_exchange=True,
        exchange_price=range(5000, 6500),
    ),
    Item(
        name="велик",
        emoji="🚲",
    ...
    Item(
        name="удочка",
        emoji="🎣",
        desc="Нужна для рыбалки",
        rarity=ItemRarity.RARE,
        type=ItemType.USABLE,
        can_exchange=True,
        price=7500,
        exchange_price=range(6000, 7700),
